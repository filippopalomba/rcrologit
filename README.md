...
- The heterogeneous taste coefficients are modeled as a joint multivariate normal and are i.i.d. across units with mean parametrized by $\boldsymbol{\beta_{\mathtt{R}}}$ and $\boldsymbol{\alpha_{\mathtt{R}}}$ and variance $\boldsymbol{\Sigma}$.
