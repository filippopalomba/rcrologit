...
- The heterogeneous taste coefficients are modeled as a joint multivariate normal and are i.i.d. across units with mean $[\boldsymbol{\alpha}_{\mathtt{R}}^\top, \boldsymbol{\beta}_{\mathtt{R}}^\top]$and variance $\boldsymbol{\Sigma}$.
