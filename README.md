...
- The heterogeneous taste coefficients are modeled as a joint multivariate normal and are i.i.d. across units with mean parametrized by $\boldsymbol{\beta}$ and $\boldsymbol{\alpha}$ and variance $\boldsymbol{\Sigma}$.
