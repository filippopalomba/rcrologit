...
- The heterogeneous taste coefficients are modeled as a joint multivariate normal and are i.i.d. across units
  $$
  \left(\boldsymbol{\alpha}_i^\top, \boldsymbol{\beta}_i^\top\right)^\top 
  $$
