...
#' @param covs.fix covariates varying at the alternative-worker level with fixed taste parameter
#' @param covs.het covariates varying at the alternative-worker level with random taste parameter
#' @param covsInt.fix covariates varying at the worker level with fixed taste parameter
...
#' @references
#' \itemize{
#' \item{McFadden, Daniel. “Frontiers in Econometrics.” In \emph{Conditional Logit Analysis of Qualitative Choice Behavior}, 105–42, 1974.}
#' }
#' 
